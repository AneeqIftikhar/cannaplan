...
class Tax extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['forecast_id', 'name', 'coorporate_tax', 'coorporate_payable_time', 'sales_tax', 'sales_payable_time', 'deleted_at', 'remember_token', 'created_at', 'updated_at'];
