...
class Company extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['currency_id', 'user_id', 'title', 'business_stage', 'start_of_forecast', 'length_of_forecast', 'monthly_detail', 'deleted_at', 'remember_token', 'created_at', 'updated_at'];
